    ...
    <div>
      ...
      <div className='my-10 flex flex-col md:flex-row gap-12'>
        ...
        <div className='flex flex-col justify-center gap-6 md:w-2/4 text-sm text-gray-600'>
          <p>Welcome tp Prescripto,your trusted partner in managing your healthcare
          ...
          <p>Prescripto is committed to excellence in healthcare technology.
            ...
            whether you are booking your first appointment or managing ongoing cae,
      ...
      <div className='flex flex-col md:flex-row mb-20'>
       <div className='border px-10 md:px-16 py-8 sm:py-6 flex flex-col gap-5 text-[15px]
